...
export const experiences: Dict = {
  pt: {
    ...
    items: [
      ...
      {
        key: 'activities', img: 'photos/piscine-jungle', title: 'Atividades & arredores',
        text: 'A poucos minutos a pé do Cristo Redentor e da Floresta da Tijuca, a poucos minutos de carro de Santa Teresa e das praias icônicas do Rio. Um equilíbrio raro entre um refúgio tropical tranquilo e o melhor do Rio, bem pertinho.',
        sections: [
          { title: 'Corcovado & Floresta da Tijuca', text: 'A 10–15 min a pé da estação base do trem do Corcovado. A Floresta da Tijuca — trilhas, cachoeiras, natureza imersiva — fica igualmente pertinho.' },
          { title: 'Santa Teresa & Lapa', text: 'O bairro boêmio-chique de Santa Teresa fica a 10–15 min de carro, com seus casarões coloniais, ateliês de artistas e mirantes escondidos. Os Arcos da Lapa ficam à mesma distância de carro (ou uma descida cênica de 25–35 min a pé por Santa Teresa).' },
          { title: 'Humaitá & Jardim Botânico', text: 'Humaitá, bairro residencial tranquilo entre a Lagoa e Botafogo, fica a 10–15 min de carro. O Jardim Botânico — caminhos entre palmeiras, restaurantes à beira da lagoa e compras sofisticadas — fica a cerca de 20 min.' },
          { title: 'Lagoa Rodrigo de Freitas', text: "A lagoa fica a 10–15 min de carro: pedalinho, caiaque, remo ou um passeio ao pôr do sol à beira d'água." },
          { title: 'Praias do Rio', text: 'Botafogo e Flamengo (10–15 min), Copacabana (15–20 min), Praia Vermelha e Urca (15–20 min), Ipanema e Leblon (20–25 min) — todo o litoral carioca a poucos minutos.' },
          { title: 'Como chegar', text: 'Aeroporto Santos Dumont (SDU), 15–20 min; Aeroporto Internacional do Galeão (GIG), 30–45 min.' },
        ],
      },
    ],
  ...
  en: {
    ...
    items: [
      ...
      {
        key: 'activities', img: 'photos/piscine-jungle', title: 'Activities & surroundings',
        text: "Just steps from Christ the Redeemer and the Tijuca rainforest, minutes from the boho-chic streets of Santa Teresa and Rio's iconic beaches. A rare balance between a peaceful garden retreat and the best of Rio, all within easy reach.",
        sections: [
          { title: 'Corcovado & Tijuca Forest', text: '10–15 min walk to the Corcovado train base station. The Tijuca National Forest — trails, waterfalls, immersive nature — is just as close.' },
          { title: 'Santa Teresa & Lapa', text: "The boho-chic hillside district of Santa Teresa is 10–15 min by car, with its colonial mansions, artist studios and hidden viewpoints. The historic Lapa Arches are a similar 10–15 min drive (or a scenic 25–35 min walk down through Santa Teresa)." },
          { title: 'Humaitá & Jardim Botânico', text: 'Humaitá, a quiet residential pocket between Lagoa and Botafogo, is 10–15 min by car. The Jardim Botânico — palm-lined paths, lakeside restaurants and boutique shopping — is about 20 min away.' },
          { title: 'Lagoa Rodrigo de Freitas', text: 'The lagoon is 10–15 min by car: cycling, kayaking, rowing or a sunset walk by the water.' },
          { title: "Rio's beaches", text: 'Botafogo and Flamengo (10–15 min), Copacabana (15–20 min), Praia Vermelha and Urca (15–20 min), Ipanema and Leblon (20–25 min) — the whole coastline within easy reach.' },
          { title: 'Getting here', text: 'Santos Dumont Airport (SDU), 15–20 min; Galeão International Airport (GIG), 30–45 min.' },
        ],
      },
    ],
  ...
  fr: {
    ...
    items: [
      ...
      {
        key: 'activities', img: 'photos/piscine-jungle', title: 'Activités & alentours',
        text: 'À quelques minutes à pied du Christ Rédempteur et de la forêt de Tijuca, à quelques minutes en voiture de Santa Teresa et des plages emblématiques de Rio. Un équilibre rare entre un havre de paix tropical et le meilleur de Rio, à portée de main.',
        sections: [
          { title: 'Corcovado & forêt de Tijuca', text: 'À 10–15 min à pied de la gare de base du train du Corcovado. La forêt de Tijuca — sentiers, cascades, nature immersive — est tout aussi proche.' },
          { title: 'Santa Teresa & Lapa', text: "Le quartier boho-chic de Santa Teresa, à 10–15 min en voiture, avec ses maisons coloniales, ateliers d'artistes et points de vue cachés. Les Arcs de Lapa sont à la même distance en voiture (ou une descente pittoresque de 25–35 min à pied via Santa Teresa)." },
          { title: 'Humaitá & Jardim Botânico', text: "Humaitá, quartier résidentiel paisible entre la Lagoa et Botafogo, à 10–15 min en voiture. Le Jardin Botanique — allées de palmiers, restaurants au bord du lac et boutiques raffinées — se trouve à environ 20 minutes." },
          { title: 'Lagoa Rodrigo de Freitas', text: "La lagune est à 10–15 min en voiture : vélo, kayak, aviron ou promenade au coucher du soleil au bord de l'eau." },
          { title: 'Plages de Rio', text: 'Botafogo et Flamengo (10–15 min), Copacabana (15–20 min), Praia Vermelha et Urca (15–20 min), Ipanema et Leblon (20–25 min) — tout le littoral carioca à quelques minutes.' },
          { title: 'Comment venir', text: 'Aéroport Santos Dumont (SDU), 15–20 min ; aéroport international de Galeão (GIG), 30–45 min.' },
        ],
      },
    ],
