...
export const common: Dict = {
  pt: {
    ...
    contactUs: 'Fale conosco', callUs: 'Ligue para nós',
  ...
  en: {
    ...
    contactUs: 'Contact us', callUs: 'Call us',
  ...
  fr: {
    ...
    contactUs: 'Nous contacter', callUs: 'Nous appeler',
...
export const spa: Dict = {
  pt: {
    metaTitle: 'Spa & bem-estar — Les Jardins de Rio',
    metaDesc: 'Um spa a céu aberto: massagens e tratamentos sob consulta, e relaxamento à beira da piscina cristalina, no jardim tropical do Cosme Velho.',
    ...
    items: [
      ...
      { key: 'eau', img: 'photos/jardin-aerien', title: 'Relaxar à beira da água', text: 'Piscina cristalina, espreguiçadeiras e pool bar: uma pausa aquática sob a copa tropical.' },
      { key: 'yoga', logo: true, title: 'Yoga & holístico', text: 'Sessões de yoga no rooftop e oficinas holísticas, em formatos íntimos, sob consulta.' },
    ],
  },
  en: {
    metaTitle: 'Spa & wellness — Les Jardins de Rio',
    metaDesc: 'An open-air spa: massages and treatments on request, and relaxation by the crystal-clear pool, in the tropical garden of Cosme Velho.',
    ...
    items: [
      ...
      { key: 'eau', img: 'photos/jardin-aerien', title: 'Relaxation by the water', text: 'Crystal-clear pool, sunbeds and pool bar: an aquatic pause under the tropical canopy.' },
      { key: 'yoga', logo: true, title: 'Yoga & holistic', text: 'Rooftop yoga sessions and holistic workshops, in intimate formats, on request.' },
    ],
  },
  fr: {
    metaTitle: 'Spa & bien-être — Les Jardins de Rio',
    metaDesc: "Un spa à ciel ouvert : massages et soins sur demande, et détente au bord de la piscine cristalline, dans le jardin tropical de Cosme Velho.",
    ...
    items: [
      ...
      { key: 'eau', img: 'photos/jardin-aerien', title: "Détente au fil de l'eau", text: 'Piscine cristalline, transats et pool bar : une parenthèse aquatique sous la canopée tropicale.' },
      { key: 'yoga', logo: true, title: 'Yoga & holistique', text: 'Séances de yoga sur le rooftop et ateliers holistiques, en formats intimes, sur demande.' },
    ],
  },
};
...
export const experiences: Dict = {
  pt: {
    ...
    items: [
      { key: 'gastronomy', img: 'photos/bar-interieur', cta: false, title: 'Bar', text: 'Um bar coberto e equipado à beira da piscina, prolongado pelo pool house e por uma sala de jantar coberta. De manhã, o café da manhã é servido de frente para o jardim — frutas tropicais, sucos naturais, waffles e pães frescos, café brasileiro. Ao entardecer, entram os coquetéis do barman e uma seleção de vinhos, noite adentro sob a copa das árvores.' },
      ...
      { key: 'workshops', img: 'photos/terrasse-palmier', cta: 'Escreva-nos', title: 'Oficinas & workshops', text: 'Café da manhã-ateliê, yoga no rooftop, oficinas holísticas e criativas: formatos íntimos em um cenário inspirador.' },
    ],
  ...
  en: {
    ...
    items: [
      ...
      { key: 'workshops', img: 'photos/terrasse-palmier', cta: 'Write to us', title: 'Workshops', text: 'Breakfast-ateliers, rooftop yoga, holistic and creative workshops: intimate formats in an inspiring setting.' },
    ],
  ...
  fr: {
    ...
    items: [
      { key: 'gastronomy', img: 'photos/bar-interieur', cta: false, title: 'Bar', text: 'Un bar couvert et équipé au bord de la piscine, prolongé par le pool house et une salle à manger couverte. Le matin, le petit-déjeuner se prend face au jardin — fruits tropicaux, jus pressés, gaufres et pains frais, café brésilien. Le soir venu, place aux cocktails du barman et à une sélection de vins, jusque tard sous la canopée.' },
      ...
      { key: 'workshops', img: 'photos/terrasse-palmier', cta: 'Écrivez-nous', title: 'Ateliers & workshops', text: 'Petit-déjeuner-atelier, yoga sur le rooftop, ateliers holistiques et créatifs : des formats intimes dans un cadre inspirant.' },
    ],
