...
|---|---|---|---|
| Chambres + accueil | `assets-src/rooms/<id>/` | presidential-white, amethyst, library, botanical, sunset-garden, corcovado, red, maracuja — **nomenclature : [`assets-src/README.md`](../assets-src/README.md)** | 1 photo chacune (white = repli CDN) |
